#block_placer
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.block_placer] at @s unless block ~ ~ ~ dispenser run summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,components:{"minecraft:item_model":"minecraft:dispenser","minecraft:item_name":'[{"text":"block_placer"}]',"minecraft:custom_data":{"block_placer":true},"minecraft:entity_data":{id:"item_frame",Tags:['reddition.blocks.block_place.block_placer', 'reddition.blocks', 'reddition.has_cooldown']}}}}
...
#block_breaker
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.block_breaker] at @s unless block ~ ~ ~ dispenser run summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,components:{"minecraft:item_model":"minecraft:dispenser","minecraft:item_name":'[{"text":"block_breaker"}]',"minecraft:custom_data":{"block_breaker":true},"minecraft:entity_data":{id:"item_frame",Tags:['reddition.blocks.block_place.block_breaker', 'reddition.blocks', 'reddition.has_cooldown']}}}}
...
#conveyor
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.conveyor] at @s unless block ~ ~ ~ dispenser run summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,components:{"minecraft:item_model":"minecraft:dropper","minecraft:item_name":'[{"text":"conveyor"}]',"minecraft:custom_data":{"conveyor":true},"minecraft:entity_data":{id:"item_frame",Tags:['reddition.blocks.block_place.conveyor', 'reddition.blocks', 'reddition.has_cooldown']}}}}
...
#block_rotator
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.block_rotator] at @s unless block ~ ~ ~ sticky_piston run summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,components:{"minecraft:item_model":"minecraft:sticky_piston","minecraft:item_name":'[{"text":"block_rotator"}]',"minecraft:custom_data":{"block_rotator":true},"minecraft:entity_data":{id:"item_frame",Tags:['reddition.blocks.block_place.block_rotator', 'reddition.blocks', 'reddition.has_cooldown']}}}}
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.block_rotator] at @s unless block ~ ~ ~ sticky_piston run kill @s
#exporter
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.exporter] at @s unless block ~ ~ ~ pale_oak_fence_gate run summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,components:{"minecraft:item_model":"minecraft:pale_oak_fence_gate","minecraft:item_name":'[{"text":"exporter"}]',"minecraft:custom_data":{"exporter":true},"minecraft:entity_data":{id:"item_frame",Tags:['reddition.blocks.block_place.exporter', 'reddition.blocks', 'reddition.has_cooldown']}}}}
...
#lava_reactor
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.lava_reactor] at @s unless block ~ ~ ~ dispenser run summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,components:{"minecraft:item_model":"minecraft:dispenser","minecraft:item_name":'[{"text":"lava_reactor"}]',"minecraft:custom_data":{"lava_reactor":true},"minecraft:entity_data":{id:"item_frame",Tags:['reddition.blocks.block_place.lava_reactor', 'reddition.blocks', 'reddition.has_cooldown']}}}}
...
#breeder
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.breeder] at @s unless block ~ ~ ~ dispenser run summon item ~ ~ ~ {Item:{id:"minecraft:item_frame",Count:1b,components:{"minecraft:item_model":"minecraft:dispenser","minecraft:item_name":'[{"text":"breeder"}]',"minecraft:custom_data":{"breeder":true},"minecraft:entity_data":{id:"item_frame",Tags:['reddition.blocks.block_place.breeder', 'reddition.blocks', 'reddition.has_cooldown']}}}}
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.breeder] at @s unless block ~ ~ ~ dispenser run kill @s
