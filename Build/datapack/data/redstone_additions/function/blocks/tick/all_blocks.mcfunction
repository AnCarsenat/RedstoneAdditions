...
#block_breaker
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.block_breaker] at @s unless block ~ ~ ~ dropper run kill @s
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.block_breaker] if score @s redstone_additions.delay matches 19.. at @s if block ~ ~ ~ minecraft:dropper[triggered=true] run setblock ^ ^0 ^1 air destroy
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.block_breaker] if score @s redstone_additions.delay matches 19.. run scoreboard players set @s redstone_additions.delay 0
#conveyor
...
scoreboard players reset @e[type=armor_stand,tag=reddition.blocks.block_place.exporter] reddition.temp
#lava_reactor
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.lava_reactor] at @s unless block ~ ~ ~ dispenser run kill @s
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.lava_reactor] if score @s redstone_additions.delay matches 99.. at @s run setblock ^ ^ ^1 lava keep
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.lava_reactor] if score @s redstone_additions.delay matches 99.. run scoreboard players set @s redstone_additions.delay 0
scoreboard players reset @e[type=armor_stand,tag=reddition.blocks.block_place.lava_reactor] reddition.temp
#mineral_reactor
...
scoreboard players reset @e[type=armor_stand,tag=reddition.blocks.block_place.mineral_reactor] reddition.temp
#organic_reactor
...
scoreboard players reset @e[type=armor_stand,tag=reddition.blocks.block_place.organic_reactor] reddition.temp
