...
#block_rotator
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.block_rotator] at @s unless block ~ ~ ~ minecraft:sticky_piston run kill @e[type=item,nbt={Item:{id:"minecraft:sticky_piston"}},sort=nearest,limit=1]
...
#exporter
execute as @e[type=armor_stand,tag=reddition.blocks.block_place.exporter] at @s unless block ~ ~ ~ minecraft:pale_oak_fence_gate run kill @e[type=item,nbt={Item:{id:"minecraft:pale_oak_fence_gate"}},sort=nearest,limit=1]
