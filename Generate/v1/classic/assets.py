...
ITEMS = {
    ...
    "mineral_core": Item(
        ...
        entity_tags=["reddition.blocks.block_place.reactor","reddition.blocks","reddition.has_cooldown"],
        block_place=None,
...
BLOCKS = {
    "block_placer": Item(
        ...
        entity_data={"id": "item_frame"},
        entity_tags=["reddition.blocks.block_place.block_placer","reddition.blocks","reddition.has_cooldown"],
    ...
    "block_breaker": Item(
        ...
        entity_data={"id": "item_frame"},
        entity_tags=["reddition.blocks.block_place.block_breaker","reddition.blocks","reddition.has_cooldown"],
        block_place=BlockPlace(block="dropper", facing_type=BlockPlace.FacingTypes.ALL),
        additional_item_data="",
    ),
    "conveyor": Item(
        name="conveyor",
        ...
        entity_data={"id": "item_frame"},
        entity_tags=["reddition.blocks.block_place.conveyor","reddition.blocks","reddition.has_cooldown"],
        block_place=BlockPlace(block="dispenser", facing_type=BlockPlace.FacingTypes.ALL),
        additional_item_data="",
    ),
    "block_rotator": Item(
        ...
        entity_data={"id": "item_frame"},
        entity_tags=["reddition.blocks.block_place.block_rotator","reddition.blocks","reddition.has_cooldown"],
        block_place=BlockPlace(block="sticky_piston", facing_type=BlockPlace.FacingTypes.ALL),
        additional_item_data="",
    ),
    "exporter": Item(
        name="exporter",
        ...
        entity_data={"id": "item_frame"},
        entity_tags=["reddition.blocks.block_place.exporter","reddition.blocks","reddition.has_cooldown"],
        block_place=BlockPlace(block="pale_oak_fence_gate", facing_type=BlockPlace.FacingTypes.LINK),
        additional_item_data="",
    ),
    "lava_reactor": Item(
        name="lava_reactor",
        ...
        entity_data={"id": "item_frame"},
        entity_tags=["reddition.blocks.block_place.lava_reactor","reddition.blocks","reddition.has_cooldown"],
        block_place=BlockPlace(block="dispenser", facing_type=BlockPlace.FacingTypes.ALL),
        additional_item_data="",
    ),
    "mineral_reactor": Item(
        ...
        entity_data={"id": "item_frame"},
        entity_tags=["reddition.blocks.block_place.mineral_reactor","reddition.blocks","reddition.has_cooldown"],
        block_place=BlockPlace(block="dispenser", facing_type=BlockPlace.FacingTypes.ALL),
        additional_item_data="",
    ),
    "organic_reactor": Item(
        ...
        entity_data={"id": "item_frame"},
        entity_tags=["reddition.blocks.block_place.organic_reactor","reddition.blocks","reddition.has_cooldown"],
        block_place=BlockPlace(block="dispenser", facing_type=BlockPlace.FacingTypes.ALL),
        additional_item_data="",
    ),
}
...
block_breaker_block_tick = BlockPlace.blockTickMcfunction(
    name="block_breaker",
    commands=[
        f"execute as {BLOCKS['block_breaker'].generate_child_entities_selector_from_id("armor_stand")} at @s unless block ~ ~ ~ {BLOCKS['block_breaker'].block_place.block} run kill @s",
        f"execute as {BLOCKS['block_breaker'].generate_child_entities_selector_from_id("armor_stand")} if score @s redstone_additions.delay matches 19.. at @s if block ~ ~ ~ minecraft:dropper[triggered=true] run setblock ^ ^0 ^1 air destroy",
        f"execute as {BLOCKS['block_breaker'].generate_child_entities_selector_from_id("armor_stand")} if score @s redstone_additions.delay matches 19.. run scoreboard players set @s redstone_additions.delay 0",
    ]
)
...
exporter_block_tick = BlockPlace.blockTickMcfunction(
    ...
    commands=[
        ...
        f"scoreboard players reset {BLOCKS['exporter'].generate_child_entities_selector_from_id("armor_stand")} reddition.temp"
    ]
)
...
lava_reactor_block_tick = BlockPlace.blockTickMcfunction(
    name="lava_reactor",
    commands=[
        f"execute as {BLOCKS['lava_reactor'].generate_child_entities_selector_from_id("armor_stand")} at @s unless block ~ ~ ~ {BLOCKS['lava_reactor'].block_place.block} run kill @s",
        f"execute as {BLOCKS['lava_reactor'].generate_child_entities_selector_from_id("armor_stand")} if score @s redstone_additions.delay matches 99.. at @s run setblock ^ ^ ^1 lava keep",
        f"execute as {BLOCKS['lava_reactor'].generate_child_entities_selector_from_id("armor_stand")} if score @s redstone_additions.delay matches 99.. run scoreboard players set @s redstone_additions.delay 0",
    
        f"scoreboard players reset {BLOCKS['lava_reactor'].generate_child_entities_selector_from_id("armor_stand")} reddition.temp"
    ]
)
# scoreboard players set @e[type=armor_stand,tag=reddition.blocks.block_place.block_breaker] redstone_additions.delay 0
mineral_reactor_block_tick = BlockPlace.blockTickMcfunction(
    ...
    commands=[
        ...
        f"scoreboard players reset {BLOCKS['mineral_reactor'].generate_child_entities_selector_from_id("armor_stand")} reddition.temp"
    ]
)
...
organic_reactor_block_tick = BlockPlace.blockTickMcfunction(
    ...
    commands=[
        ...
        f"scoreboard players reset {BLOCKS['organic_reactor'].generate_child_entities_selector_from_id("armor_stand")} reddition.temp"
    ]
)
